    ...
    T: Deserialize<'de>,
{
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        use swc_common::private::content::{deserialize_content, ContentDeserializer};

        let content = deserialize_content(deserializer)?;
        let content2 = content.clone();

        let d = ContentDeserializer::<D::Error>::new(content);
        let res = Deser::deserialize(d);
        ...
        match res {
            ...
            Err(..) => {
                let d = ContentDeserializer::<D::Error>::new(content2);
